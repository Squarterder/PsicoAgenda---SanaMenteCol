...
> **Nota:** Si prefieres no usar el archivo `.env`, puedes editar directamente `psicoagenda/settings.py` con tus datos. El sistema funciona igual sin configurar el correo, simplemente no se enviarán notificaciones.
...
| Psicóloga | psicologa | Psi2024 |
| Paciente | paciente1 | Pac2024 |
...
5. Pégalos en `EMAIL_HOST_PASSWORD` dentro de `.env` o `settings.py`
